              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return DefaultTaskCountSummaryCard(
                      ...
                      onTap: (){
                        if ( _newTaskStatusCountList[index].id== "Progress") {
                          Navigator.pushNamed(context, ProgressTaskListScreen.name);
                        }
                        else if ( _newTaskStatusCountList[index].id== "Completed") {
                          Navigator.pushNamed(context, CompleteTaskListScreen.name);
                        }
                        else if ( _newTaskStatusCountList[index].id== "Canceled") {
                          Navigator.pushNamed(context, CanceledTaskListScreen.name);
                        }
                      },
                  );
                },
